...
open class DatePickerDialog: UIView {
    ...
    @objc public init(buttonColor: UIColor = (UIApplication.shared.keyWindow?.tintColor)!,
    ...
    private func createContainerView() -> UIView {
        ...
        let dialogSize = CGSize(width: 320, height: 250 + kDefaultButtonHeight + kDefaultButtonSpacerHeight)
    ...
    fileprivate func configuredDatePicker() -> UIDatePicker {
        ...
        datePicker.frame.size.width = 320
