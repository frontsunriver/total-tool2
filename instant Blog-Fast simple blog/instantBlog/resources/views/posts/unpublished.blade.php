...
<div class="container">
    <div class="row ml-3 mr-3">
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link" href="{{ url('/contents/') }}">Published</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" href="{{ url('/unpublished/') }}">Unpublished</a>
            </li>
        </ul>
    </div>  
    <div class="row box-white ml-3 mr-3">
        <table class="table table-sm table-hover">
            ...
            <tbody>
                ...
                <button name="mulbtn"  type="submit" class="btn btn-secondary btn-sm ml-2" value="Publish">Publish</button>
            </form>
    </div>
    <div class="row">
        <div class="col-md-12">
