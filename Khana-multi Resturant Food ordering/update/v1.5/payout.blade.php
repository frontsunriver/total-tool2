		...
		<div class="card">
			<div class="card-header ">
				...
				<div class="text-center">
					<a href="{{ route('rider.payout.edit') }}" class="text-left"><img src="{{ asset('uploads/paypal.png') }}" height="65"></a>
					<a href="{{ route('rider.payout.edit') }}" class="text-right ml-5"><img src="{{ asset('uploads/bank.png') }}" height="40"></a>
				</div>
			</div>
			<div class="card-body text-left">
				
				<a href="{{ route('rider.payout.edit') }}">{{ __('Edit Payout Information') }}</a>
			</div>
		</div>
	</div>
	<div class="col-sm-6">
		<div class="card">
			<div class="card-header ">
				...
				<h2 class="text-right ml-5"><strong>{{ strtoupper($currency->value) }}{{ $total }}</strong></h2>
			</div>
			<div class="card-body text-left">
	...
	<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form method="post" action="{{ route('rider.withdraw') }}" id="basicform">
					@csrf
