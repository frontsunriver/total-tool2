 ...
 <div class="col-lg-9">      
  <div class="card">
   <div class="card-body">
    ...
    <form method="post" id="basicform" action="{{ route('store.product.update',$info->id) }}">
     @csrf
     @method('PUT')
     <div class="custom-form pt-20">
       ...
       $arr['id']= 'price';
       $arr['type']= 'number';
       $arr['placeholder']= 'Product Price';
       $arr['name']= 'price';
       $arr['value']= $info->price->price;
  ...
  <div class="card-body">
   ...
   <div class="scroll-bar-wrap">
     <div class="category-list">
      ...
      <?php echo AdminCategoryUpdate(1, $catArr); ?>
