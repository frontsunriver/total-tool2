...
<div class="card"  >
	<div class="card-body">
		...
		<div class="cart-filter mb-20">
			<a href="{{ route('admin.badge.index','type=rider') }}">{{ __('All') }} <span>({{ App\Terms::where('type',4)->where('status','!=',0)->count() }})</span></a>
			<a href="?st=1&type=rider">{{ __('Published') }} <span>({{ App\Terms::where('type',4)->where('status',1)->count() }})</span></a>
			<a href="?st=2&type=rider">{{ __('Drafts') }} <span>({{ App\Terms::where('type',4)->where('status',2)->count() }})</span></a>
			<a href="?st=trash&type=rider" class="trash">{{ __('Trash') }} <span>({{ App\Terms::where('type',4)->where('status',0)->count() }})</span></a>
		</div>
