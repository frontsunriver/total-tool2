...
class GamesManager{
    ...
    func getGames(limit:Int, offset: Int, type: String,completionBlock :@escaping (_ Success: GamingModel.GamingSuccessModel?, _ AuthError: GamingModel.GamingErrorModel?, Error?)->()){
        ...
        Alamofire.request(APIClient.Games.getGames + access_token, method: .post, parameters: params, encoding: URLEncoding.default, headers: nil).responseJSON { (response) in
