...
class WalletManager{
    ...
    func sendMoney(user_id: String,amount: String,completionBlock :@escaping (_ Success: SendMoneyModal.sendMoney_SuccessModal?, _ AuthError: SendMoneyModal.sendMoney_ErrorModal?, Error?)->()){
        ...
        Alamofire.request(APIClient.Wallet.walletApi + access_token, method: .post, parameters: params, encoding: URLEncoding.default, headers: nil).responseJSON { (response) in
