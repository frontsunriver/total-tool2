...
class GetGroupPostsManager{
    ...
    let access_token = "\("?")\("access_token")\("=")\(UserData.getAccess_Token()!)"
        ...
        Alamofire.request(APIClient.GetGroupPost.getGroupPostApi + access_token, method: .post, parameters: params, encoding: URLEncoding.default, headers: nil).responseJSON { (response) in
