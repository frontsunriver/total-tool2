...
class VideosModel{
    // MARK: - Welcome
    struct VideosSuccessModel: Codable {
        var apiStatus: Int?
        var data: [Datum]?
    ...
    struct VideosErrorModel : Codable {
    ...
    struct Datum: Codable {
        ...
        var getPostComments: [GetPostComment]?
        var photoAlbum, options: [JSONAny]?
        var votedID: Int?
    ...
    struct GetPostComment: Codable {
        var id, userID, pageID, postID: String?
        var text, cFile, record, time: String?
        var publisher: GetPostCommentPublisher?
        var url, fullurl: String?
        var orginaltext: String?
        var onwer, postOnwer: Bool?
        var commentLikes, commentWonders: String?
        var isCommentWondered, isCommentLiked: Bool?
        var reaction: Reaction?
    ...
    // MARK: - GetPostCommentPublisher
    struct GetPostCommentPublisher: Codable {
        ...
        var url: String?
        var name, mutualFriendsData, lastseenUnixTime, lastseenStatus: String?
