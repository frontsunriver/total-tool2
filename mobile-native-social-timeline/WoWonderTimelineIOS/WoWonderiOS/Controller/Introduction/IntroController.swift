...
class IntroController: UIViewController,UIScrollViewDelegate {
    ...
    func createSlides() -> [IntroImageSlider] {
        ...
        slide3.textLabel.text = NSLocalizedString("New Features", comment: "New Features")
        slide3.descriptionLabel.text = NSLocalizedString("Send & Recieve all kind of messages", comment: "Send & Recieve all kind of messages")
        ...
        slide4.textLabel.text = NSLocalizedString("Stay Sync", comment: "Stay Sync")
        slide4.descriptionLabel.text = NSLocalizedString("Keep you conversation going from all devices", comment: "Keep you conversation going from all devices")
