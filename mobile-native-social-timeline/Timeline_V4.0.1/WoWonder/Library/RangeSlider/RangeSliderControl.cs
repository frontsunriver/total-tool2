...
namespace WoWonder.Library.RangeSlider
{
    ...
    {
        private static readonly Color DefaultDarkBlueColor = Color.Argb(255, 51, 181, 229);
        private static readonly Color DefaultLightBlueColor = Color.Argb(154, 51, 181, 229);
        private static readonly Color DefaultGrayColor = Color.Argb(77, 136, 136, 136);
        private static readonly Color DefaultLightestBlueColor = Color.Argb(102, 51, 181, 229);

        /// <summary>
        ///     An invalid pointer id.
        /// </summary>
        private const int InvalidPointerId = 255;
        ...
        private const int HeightInDp = 16;
        private const int TextLateralPaddingInDp = 5;
        ...
        private readonly float MinDeltaForDefault = 0;
        private float NormalizedMaxValue = 1f;
